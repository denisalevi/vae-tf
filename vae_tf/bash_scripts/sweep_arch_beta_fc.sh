...
do
	...
	python run_clustering.py --arch 500 500 "$L_DIM" --cluster_train --cluster_test --save fc_accuracies.txt --log_folder fc --beta 1
	echo ""
	echo ""
done
...
do
	...
	do
		...
		python run_clustering.py --arch $LA $L_DIM --cluster_train --cluster_test --save fc_accuracies.txt --log_folder fc --beta 1
		echo ""
		echo ""
	done
done
...
do
	...
	do
		...
		python run_clustering.py --arch $LA $LA $L_DIM --cluster_train --cluster_test --save fc_accuracies.txt --log_folder fc --beta 1
		echo ""
		echo ""
	done
done
...
do
	...
	python run_clustering.py --beta "$B" --arch 500 500 10 --cluster_train --cluster_test --log_folder fc --save fc_accuracies.txt
	echo ""
	echo ""
done
